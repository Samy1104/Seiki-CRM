...
// BulkImportPanel pulls in leadImportService -> the real (unmocked) supabaseClient,
// which throws at module load time in the test environment. Since the single-lead
// tests below never switch to bulk mode, a lightweight stand-in avoids that crash
// without affecting single-lead coverage.
...
describe('AddLead View', () => {
  ...
  it('defaults to the single-lead form and switches to bulk import when toggled', async () => {
    render(<AddLead setView={vi.fn()} />);
